 ...
 */
class FieldCryptoServiceTest extends MongoAdapterTestBase {
    ...
    void decryptStringField_aesGcm() {
        ...
        Document result = (Document) fieldCryptoService.decryptDocument(doc, TestUser.class);
    ...
    void plainEntityNoOp() {
        ...
        Document result = (Document) fieldCryptoService.decryptDocument(doc, TestPlainEntity.class);
