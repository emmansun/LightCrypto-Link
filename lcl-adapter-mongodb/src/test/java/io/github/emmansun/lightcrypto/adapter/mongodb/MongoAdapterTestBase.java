 ...
 */
public abstract class MongoAdapterTestBase {
    static {
    ...
    protected VaultStore createInMemoryVaultStore() {
        return new InMemoryVaultStore();
    }

    /**
     * Creates a simple BSON-based StorageAdapter for testing.
     */
    protected StorageAdapter createTestStorageAdapter() {
        return new MongoStorageAdapter();
    }

    /**
     * Creates a BSON-based StructuredValueCodec for testing.
     */
    protected StructuredValueCodec createTestStructuredValueCodec() {
        return new BsonStructuredValueCodec();
    }

    /**
     * Creates a BSON-based DocumentAccessor for testing.
     */
    protected DocumentAccessor createTestDocumentAccessor() {
