...
class KeyVaultCorruptionTest {
    ...
    void kcvMismatchThrowsFatalCryptoException() {
        ...
        Update update = new Update().set("keys.$.dekKcv", "00000000000000000000000000000000");
    ...
    void staleVaultSnapshotDoesNotOverwriteRotatedVault() {
        ...
        Number staleVersionNum = staleVault.get("v", Number.class);
        int staleVersion = staleVersionNum.intValue();
        ...
        Number currentVersionNum = currentVault.get("v", Number.class);
        assertThat(currentVersionNum.intValue()).isEqualTo(staleVersion + 1);
    ...
    private void restoreVaultKcv() {
        ...
        Update update = new Update()
                .set("keys.$.dekKcv", correctDekKcv)
                .set("keys.$.hmacKcv", correctHmacKcv);
        mongoTemplate.updateFirst(query, update, "__lcl_keyvault");
    }
