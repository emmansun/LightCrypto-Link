...
/**
 * Demonstrates LightCrypto-Link transparent encryption with Alibaba Cloud KMS.
 *
 * <p>How it works:
 * <ol>
 *   <li>On startup, the provider fetches the RSA public key from KMS (or uses a cached PEM).</li>
 ...
 *   <li>On read: the wrapped DEK is sent to KMS AsymmetricDecrypt to recover the plaintext DEK,
...
public class DemoRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        System.out.println("=== LightCrypto-Link Alibaba KMS Demo ===\n");
        System.out.println("CMK Provider: Alibaba Cloud KMS (RSA-OAEP SHA-256)");
        System.out.println("  - Wrap: local RSA-OAEP (zero network overhead)");
        System.out.println("  - Unwrap: KMS AsymmetricDecrypt\n");
        ...
        System.out.println("  DEK unwrapped via KMS AsymmetricDecrypt on read.\n");
