...
class ProgrammaticCryptoServiceTest extends LclTestBase {
    ...
    void setup() {
        ...
        api = new ProgrammaticCryptoService(serializer, deserializer, keyVaultService, fieldCryptoService);
    }
    ...
    void encryptAndDecryptValueWithDefaultAlgorithm() {
        ...
        assertThat(subDoc.getString("c")).isNotBlank();
    ...
    void encryptAndDecryptValueWithExplicitAlgorithm() {
        Document subDoc = api.encryptValue("hello", TEST_NAMESPACE, AlgorithmId.AES_256_CBC);
    ...
    void decryptValueWrapsKeyVaultFailureAsKeyManagementException() {
        ...
        ProgrammaticCryptoService failingApi = new ProgrammaticCryptoService(
                serializer, deserializer, failingKeyVault, fieldCryptoService);
